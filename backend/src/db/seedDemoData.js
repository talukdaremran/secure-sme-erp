...
async function seedDemoData() {
  ...
  try {
    ...
    const products = [
      ["Premium Coffee Beans 1kg", "COF-001", "Beverage", 34.9, 8, 12],
      ["Organic Green Tea Pack", "TEA-002", "Beverage", 18.5, 38, 15],
      ["Sparkling Water 24 Pack", "WAT-003", "Beverage", 22.0, 6, 10],
      ["Office Copy Paper A4", "PAP-004", "Office", 8.8, 45, 20],
      ["Thermal Receipt Rolls", "ROL-005", "Office", 14.2, 9, 14],
      ["Wireless Barcode Scanner", "SCN-006", "Electronics", 129.0, 5, 6],
      ["POS Tablet Stand", "POS-007", "Electronics", 59.0, 20, 8],
      ["USB-C Charging Cable", "CAB-008", "Electronics", 12.5, 52, 20],
      ["Compostable Food Containers", "CON-009", "Packaging", 31.0, 11, 16],
      ["Paper Carry Bags Medium", "BAG-010", "Packaging", 24.5, 40, 18],
      ["Kitchen Sanitiser 5L", "SAN-011", "Cleaning", 27.5, 7, 10],
      ["Microfibre Cloth Pack", "CLT-012", "Cleaning", 16.0, 34, 12],
      ["Nitrile Gloves Box", "GLV-013", "Cleaning", 19.9, 14, 18],
      ["Olive Oil 4L", "OIL-014", "Grocery", 42.0, 10, 12],
      ["Basmati Rice 10kg", "RIC-015", "Grocery", 36.0, 26, 10],
      ["Canned Tomatoes 12 Pack", "TOM-016", "Grocery", 28.8, 18, 12],
      ["Almond Milk Carton", "MLK-017", "Grocery", 3.8, 64, 25],
      ["Granola 1kg", "GRN-018", "Grocery", 17.5, 31, 14],
      ["Protein Bar Box", "BAR-019", "Snack", 29.5, 22, 10],
      ["Dark Chocolate Pack", "CHO-020", "Snack", 11.5, 44, 16],
      ["Reusable Cutlery Set", "CUT-021", "Packaging", 9.9, 12, 10],
      ["Eco Napkins 500 Pack", "NAP-022", "Packaging", 18.0, 17, 12],
      ["Hand Wash Refill 5L", "HND-023", "Cleaning", 21.0, 6, 9],
      ["Bluetooth Label Printer", "LBL-024", "Electronics", 189.0, 4, 5],
    ];
    ...
    for (const product of products) {
      const result = await client.query(
        `INSERT INTO products
           (name, sku, category, price, stock_quantity, low_stock_level)
         VALUES ($1, $2, $3, $4, $5, $6)
